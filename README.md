...
<head>
	<meta charset="UTF-8">
	<title>Impacto de la tecnologia en tiempos de pandemia</title>
<style>
	body{
		background-color:rgb(249,197,183);
	}
#Critica{
	width: 425px;
	color: rgb(32,8,32);
